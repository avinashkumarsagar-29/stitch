          ...
          {!isRegister && (
            <div className="flex items-center justify-between mt-6 mb-7 text-[10px] font-extrabold uppercase tracking-widest">
              <div className="flex items-center gap-2">
                <span
                  className={`flex h-6.5 w-6.5 items-center justify-center rounded-full text-[10px] font-extrabold transition-all duration-300 ${
                    !isOtpSent ? "bg-[#c322f4] text-white" : "bg-purple-100 text-[#c322f4]"
                  }`}
                >
                  1
                </span>
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`flex h-6.5 w-6.5 items-center justify-center rounded-full text-[10px] font-extrabold transition-all duration-300 ${
                    isOtpSent ? "bg-[#c322f4] text-white" : "bg-gray-100 text-gray-400"
                  }`}
                >
                  2
                </span>
