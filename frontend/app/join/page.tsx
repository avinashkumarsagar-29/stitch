                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      {[
                        ...
                        <button
                          ...
                          suppressHydrationWarning
                          className={`flex flex-col items-center justify-center p-3 rounded-xl border-2 text-center transition-all duration-300 cursor-pointer ${formData.plan === p.id
            ...
            <div className="mt-16 pt-12 border-t border-gray-100 animate-fade-in">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {[
                  ...
                  <article
                    key={plan.name}
                    className={`relative rounded-3xl border bg-white p-6 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:border-[#c322f4]/50 flex flex-col justify-between group ${plan.glowColor} ${plan.popular ? "border-[#c322f4] ring-2 ring-[#c322f4]/5" : "border-gray-200"
                      }`}
                  >
                    {plan.popular && (
                    ...
                    <div className="mt-8">
                      <button
                        ...
                        suppressHydrationWarning
                        className={`w-full py-3 text-center text-xs font-extrabold uppercase tracking-wider rounded-2xl transition-all duration-300 cursor-pointer ${formData.plan === plan.id
